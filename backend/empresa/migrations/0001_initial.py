    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('giro_actividad', models.CharField(max_length=50, null=True, blank=True)),
                ...
                ('sector', models.CharField(blank=True, max_length=2, null=True, choices=[(b'Sector Primario', ((b'11', b'Agroindustrial'), (b'12', b'Pesquero'), (b'13', b'Minero'), (b'14', b'Otros'))), (b'Sector Secundario', ((b'21', b'Industrial'), (b'22', b'Constructor'), (b'23', b'Petrolero'), (b'24', b'Otros'))), (b'Sector Terciario', ((b'31', b'Educativo'), (b'32', b'Turismo'), (b'33', b'Comercio'), (b'34', b'Servicios Financieros'), (b'35', b'Otros')))])),
            ],
        ),
        migrations.CreateModel(
            name='Encargado',
        ...
        migrations.AddField(
            model_name='empresa',
            name='encargado',
            field=models.ForeignKey(blank=True, to='empresa.Encargado', null=True),
        ),
    ]
